...
define view entity ZI_GD_BOOKING_M as select from zgd_booking

association to parent ZI_GD_TRAVEL_M as _Travel on $projection.TravelUuid = _Travel.Traveluuid
